...
if TYPE_CHECKING:
    from .cuda_recovery import CudaRecoveryAction
...
from app.ui.dialogs.diary_dialog import DiaryUpdateDialog
from app.ui.themes import JARVIS_THEME_STYLESHEET
from app.ui.widgets.face_widget import FaceWindow
...
def show_instance_conflict_dialog() -> bool:
    ...
    # Apply theme
    from app.themes import JARVIS_THEME_STYLESHEET
    ...
    def start_server(self) -> bool:
        ...
        try:
            ...
            if is_frozen:
                ...
                try:
                    from app.memory_viewer import app as flask_app
...
class JarvisSystemTray:
    ...
    def __init__(self):
        ...
        from app.dictation_history import DictationHistoryWindow
    ...
    def _maybe_add_cuda_recovery_action(self) -> None:
        ...
        try:
            from app.cuda_recovery import cuda_recovery_action
        except Exception as e:
    ...
    def _run_cuda_recovery(self, action_spec: "CudaRecoveryAction") -> None:
        ...
        from app.cuda_recovery import run_action
        from PyQt6.QtWidgets import QMessageBox
    ...
    def show_setup_wizard(self) -> None:
        ...
        try:
            from app.face_widget import JarvisState, get_jarvis_state
    ...
    def stop_daemon(self, show_diary_dialog: bool = True) -> None:
        ...
        try:
            if self.is_bundled and self.daemon_thread:
                ...
                from app.diary_dialog import DIARY_IPC_PREFIX
                import queue
